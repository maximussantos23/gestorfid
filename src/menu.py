...
def tempo_atual():
    ...
    """
    Adquire o tempo local de agora (data e hora), segundos para assim subtrair de 60
    equivalente ao tempo restante até o próximo minuto e é atribuído a timeout que
    será usado para definir o tempo em que a janela será atualizada, assim atualizando
    dinamicamente o tempo que está localizado no canto superior esquerdo da interface,
